...
Rectangle {
    ...
    Rectangle {
        ...
        Rectangle {
            ...
            PropertyAnimation { id: animationW; target: textBarBG; property: "width"; to: textBar.width; duration: 300 }
            PropertyAnimation { id: animationX; target: textBarBG; property: "x"; to: 0; duration: 300 }
        }
    }
