...
Item {
    ...
    Rectangle {
        ...
        PropertyAnimation { id: animationOpc; target: buttonBg; property: "opacity"; to: 0.75; duration: 300 }
        PropertyAnimation { id: animationW; target: buttonBg; property: "width"; to: button.width; duration: 300 }
        PropertyAnimation { id: animationX; target: buttonBg; property: "x"; to: 0; duration: 300 }
    ...
    function aniStart() {
        ...
        animationOpc.duration = 300
        animationOpc.start()

        animationW.to = button.width
        animationW.duration = 300
        animationW.start()

        animationX.to = 0
        animationX.duration = 300
        animationX.start()
